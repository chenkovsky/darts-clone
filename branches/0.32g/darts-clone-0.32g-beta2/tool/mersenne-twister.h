#ifndef DARTS_MERRSENNE_TWISTER_H
#define DARTS_MERRSENNE_TWISTER_H
...
public:
	...
	int_type gen();
	int_type operator()(int_type limit) { return gen() % limit; }
...
private:
	...
	static int_type to_upper(int_type value) { return value & 0x80000000U; }
	static int_type to_lower(int_type value) { return value & 0x7FFFFFFFU; }
};

inline void MersenneTwister::init(int_type seed)
{
	mt_[0]= seed;
	for (mti_ = 1; mti_ < N; ++mti_)
	{
		mt_[mti_] = 1812433253U
...
inline MersenneTwister::int_type MersenneTwister::mag01(int_type id)
{
...
#endif  // DARTS_MERRSENNE_TWISTER_H
