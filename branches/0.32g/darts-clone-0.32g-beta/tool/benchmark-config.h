#ifndef DARTS_BENCHMARK_CONFIG_H
#define DARTS_BENCHMARK_CONFIG_H
...
public:
	...
	bool benchmarks_traverse() const { return benchmarks_traverse_; }

	const char *lexicon_file_name() const { return lexicon_file_name_; }
	const char *dic_file_name() const { return dic_file_name_; }
...
inline void BenchmarkConfig::show_usage()
{
	std::cerr << "\nUsage: " << command_
...
#endif  // DARTS_BENCHMARK_CONFIG_H
