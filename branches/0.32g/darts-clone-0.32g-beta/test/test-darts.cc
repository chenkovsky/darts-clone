...
void test_dic(const Darts::DoubleArray &dic,
...
void test_common_prefix_search(const Darts::DoubleArray &dic,
	const std::vector<const char *> &keys,
	const std::vector<std::size_t> &lengths,
	const std::vector<int> &values,
	const std::set<std::string> &invalid_keys)
{
	...
	Darts::DoubleArray::result_pair_type results[MAX_NUM_RESULTS];
	Darts::DoubleArray::result_pair_type results_with_length[MAX_NUM_RESULTS];
...
void test_traverse(const Darts::DoubleArray &dic,
	const std::vector<const char *> &keys,
	const std::vector<std::size_t> &lengths,
	const std::vector<int> &values,
	const std::set<std::string> &invalid_keys)
	...
	const std::set<std::string> &invalid_keys)
{
		...
		it != valid_keys.end(); ++it, ++key_id)
	{
		...
		values[key_id] = static_cast<int>(key_id);
	}
